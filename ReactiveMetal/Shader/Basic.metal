...
vertex FragmentInput vertex_basic(const VertexInput input [[stage_in]]) {
...
fragment half4 fragment_basic(FragmentInput input [[stage_in]], texture2d<half> texture [[texture(0)]]) {
